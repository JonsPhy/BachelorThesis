...
is called the \textbf{exterior covariant derivative} of $\phi$. Here $d\phi \equiv d \phi^i \otimes e_i$ is the exterior derivative.

This introduces the \textbf{curvature two-form} $\Omega$ as the exterior covariant derivative of the connection one-form $\omega$:
...
This will be proven by considering three separate cases \cite{FredericSchullerCurvaturetorsionprincipalbundlesLec24FredericSchuller2015}:
\begin{align*}
